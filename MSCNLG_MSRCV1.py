...
class AE_full(object):
    def __init__(self, L1_all, L2_all, sample_num, enc_dim_list, dec_dim_list, num_views=6, para_1=1.0, para_2=1.0,
    ...
    def partial_fit(self, X, lr):
        ...
        loss, summary, _, coef, lat_rep_1, lat_rep_2, lat_rep_3, lat_rep_4, lat_rep_5, lat_rep_6 = self.sess.run((self.loss, self.merged_summary_op, self.optimizer, self.coef, self.z['0'], self.z['1'], self.z['2'], self.z['3'], self.z['4'], self.z['5']), feed_dict = feed_dict)
...
if __name__ == '__main__':
    ...
    x0, x1, x2, x3, x4, x5, gt = load_data('F:/dataset/MSRCV1_6views.mat')
    ...
    s_tmp = cluster.SpectralClustering(n_clusters=7, n_neighbors=20, eigen_solver="arpack")
    ...
    enc_dim_list = [[1302, 512, 128], [20, 64, 128], [512, 256, 128], [100, 128, 128], [256, 128, 128], [210, 128, 128]]
    dec_dim_list = [[512, 1302], [64, 20], [256, 512], [128, 100], [128, 256], [128, 210]]
